        ...
        <div className="bg-[#171717] min-h-screen w-full text-white">
            ...
            <main className="flex flex-col items-center justify-center w-full">
                ...
                <section className="flex flex-col items-center justify-center w-full mb-32">
                    ...
                    >
                        Add your Anomaly and G.A.M.M.A. folders to the Windows
                        Defender exclusions and disable real-time protection
                        temporarily, <b>BEFORE</b> downloading anything. <br />
                        <Link
